...
namespace ECommerceLiteUI.Models
{
    ...
    {
        //kayıt modeli içinde siteye kayıt olmak isteyen kişilerden hangi bildirimi alacağımızı belirleyeceğiz
        //tc,isim soyisim, email gibi alanları tanımlayalım.
        //not. DataAnnotationları kullanarak validation kurallarını belirlediğimiz için kapsüllemeye gerek kalmadı.
        [Required]
...
The password's first character must be a letter, it must contain at least 5 characters 
